...
class ControlNode(Node):
    ...
    # Teclado: toggle MANUAL/AUTO + teleop integrado + shutdown con 'p'
        ...
        try:
            while rclpy.ok():
                ...
                if ch.lower() == 'p':
                    ...
                    # rompemos el contexto de ROS para detener spin()
                    rclpy.shutdown()
                    break
    ...
    def notify_shutdown(self):
        # PUBLICA LA SEÑAL PARA QUE TODOS LOS NODOS SECUNDARIOS CIERREN
    ...
    def shutdown_confirmation_callback(self, msg):
        if msg.data:
            # Los nodos secundarios confirman; opcionalmente podemos reaccionar aquí
